...
\newcommand{\thesisauthor}{Lukas Powalla}
\newcommand{\thesistopic}{Cloaced grids on solar cells}
\newcommand{\thesisentopic}{Getarnte Kontakte auf Solarzellen}
...
\newcommand{\thesisinstitute}{Institut für Angewandte Physik}
\newcommand{\thesisreviewerone}{Prof. Dr. Martin Wegener}
\newcommand{\thesisreviewertwo}{Martin Schumann}
\newcommand{\thesisadvisorone}{} % to use: enter names and uncomment in titlepg
\newcommand{\thesisadvisortwo}{}
\newcommand{\thesistimestart}{01.02.2016} % on titlepage
\newcommand{\thesistimeend}{01.05.2016} % on titlepage
\newcommand{\thesistimehandin}{20.04.2016} % on second page 'preamble'
...
\begin{document}
    ...
    \chapter{Simulations for continuous surface design}    
    \input{./chap/chapter3.tex}
	\chapter{Simulations for Fresnel design}
	\input{./chap/chapter4.tex}
	\chapter{Simulations for meta-surface design }
