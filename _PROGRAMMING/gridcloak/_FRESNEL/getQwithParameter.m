...
p.addParameter('h0',110,@isnumeric);  
p.addParameter('orig_z',300,@isnumeric);  
p.addParameter('numx',80,@isnumeric);  
p.addParameter('numy',8,@isnumeric);  
p.addParameter('numrayx',250,@isnumeric);  
p.addParameter('numrayy',25,@isnumeric);  
