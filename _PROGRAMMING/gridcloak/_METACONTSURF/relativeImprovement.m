function [relimp,totalrefracted_and_evanescent_prozent] = relativeImprovement(dphix,dphiy,alpha,beta,varargin)
...
p.addParameter('h0',300,@isnumeric);  
...
totalrefracted_and_evanescent=sum(isnan(Schnittpunktebene(:,1)));
numOnContactGrid=numOnContactGrid+totalrefracted_and_evanescent;
...
relimp=N/(N0*(1-f))-1;
totalrefracted_and_evanescent_prozent=(totalrefracted_and_evanescent/np)*100;
end